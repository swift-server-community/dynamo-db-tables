...
// https://github.com/amzn/smoke-dynamodb/tree/smoke-dynamodb-3.x/Sources/SmokeDynamoDB/InMemoryDynamoDBCompositePrimaryKeyTableStore.swift
...
internal class InMemoryDynamoDBCompositePrimaryKeyTableStore {
    ...
    internal let accessQueue = DispatchQueue(
        label: "com.amazon.DynamoDBTables.InMemoryDynamoDBCompositePrimaryKeyTable.accessQueue",
    ...
    func bulkWrite<WriteEntryType: PolymorphicWriteEntry,
        ...
        accessQueue.async {
            ...
            if entryCount > AWSDynamoDBLimits.maximumUpdatesPerTransactionStatement {
                let error = DynamoDBTableError.transactionSizeExceeded(attemptedSize: entryCount,
