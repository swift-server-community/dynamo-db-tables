...
//
//  AWSDynamoDBCompositePrimaryKeyTableDeleteTests.swift
//  DynamoDBTablesTests
//
...
struct AWSDynamoDBCompositePrimaryKeyTableDeleteTests {
    ...
    func deleteExistingItemsBatchSuccess() async throws {
        ...
        // Verify
        verify(mockClient).batchExecuteStatement(input: .any)
    }
    ...
    func deleteExistingItemsBatchChunksLargeRequests() async throws {
        ...
        verify(mockClient, times: 2).batchExecuteStatement(input: .any)
    }
