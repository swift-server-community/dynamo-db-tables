...
// https://github.com/amzn/smoke-dynamodb/tree/smoke-dynamodb-3.x/Tests/SmokeDynamoDBTests/InMemoryDynamoDBCompositePrimaryKeyTableTests.swift
...
class InMemoryDynamoDBCompositePrimaryKeyTableTests: XCTestCase {
    ...
    func testTransactWriteWithMissingRequired() async throws {
        ...
        do {
            ...
            XCTFail()
        } catch DynamoDBTableError.transactionCanceled(reasons: let reasons) {
    ...
    private struct TestInMemoryTransactionDelegate: InMemoryTransactionDelegate {
        ...
        func injectErrors<WriteEntryType: PolymorphicWriteEntry,
                          TransactionConstraintEntryType: PolymorphicTransactionConstraintEntry>(
                            ...
                            table: InMemoryDynamoDBCompositePrimaryKeyTable) async -> [DynamoDBTableError] {
            return self.errors
        }
    }
    ...
    func testBulkWriteWithExistingItem() async throws {
        ...
        do {
            ...
            XCTFail()
        } catch DynamoDBTableError.batchErrorsReturned(let errorCount, _) {
            // one required item exists, one already exists
